...
import { MapMarkerIcon } from '../icon/map-maker'
import { useState } from 'react'
import { format, addDays } from 'date-fns'
import { CalenderIcon } from '../icon/calendar'
    ...
    >
      <div className='mb-3 sm:mb-0'>
        ...
        <Text className='mb-5 hidden leading-6 !text-secondary sm:block 3xl:leading-8 4xl:mb-6 4xl:text-lg'>
          Compare prices from 200+ booking sites to help you find the lowest price on the right
          hotel for you.
        </Text>
      </div>
      {/* <SearchAutocomplete
        ...
        loader={
          <LocationInput
            label='Loading . . .'
            icon={<MapMarkerIcon className='w-6 h-6 text-gray' />}
            className='mb-3'
            disabled
          />
        }
      ...
      <DatePickerInput
        ...
        icon={<CalenderIcon className='w-6 h-6 text-gray' />}
        onChange={(date: Date) => {
          setStartDate(date)
